...
RE::BGSKeyword* Globals::DeathAvoidKeyword;
RE::BGSKeyword* Globals::Head_DeathAvoidKeyword;
RE::BGSKeyword* Globals::Torso_DeathAvoidKeyword;
...
void Globals::InitializeGlobals()
{
	...
	DeathAvoidKeyword = (RE::BGSKeyword*)Utils::GetFormFromMod("WB - EFD Damage System.esp", 0x8D7);
	Head_DeathAvoidKeyword = (RE::BGSKeyword*)Utils::GetFormFromMod("WB - EFD Damage System.esp", 0x8DE);
	Torso_DeathAvoidKeyword = (RE::BGSKeyword*)Utils::GetFormFromMod("WB - EFD Damage System.esp", 0x8DF);
}
